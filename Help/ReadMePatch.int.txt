=============================================================
UT2004 Server 3369-3 Exploit Fix Official (Linux)
=============================================================
We have new exploit-fixing executables for UT2004 Linux dedicated server executables with the recent server exploits fixed.
Note that these are just executables to replace the existing.
Josh Adams @ EpicGames

Please watch UT2004 especially carefully. It has moved to a new major version of GCC, which changed a LOT of things.
Getting the legacy codebase to build was proving non-trivial, so it's more than a few opcodes worth of changes under the hood.
Although it might turn out to be more efficient now.
Thanks,
--ryan.
...
=============================================================
UT2004 Server 3369 Exploit Fix UNOfficial (Windows)
=============================================================
UT2004 unofficial voice channel exploit fix
Autor: John "Shambler" Barrett
...
Editor:
3D Buzz Editor Enhancements (Thanks to our friends at http://www.3dbuzz.com ! Check out their UT2004 mod author video tutorials at
